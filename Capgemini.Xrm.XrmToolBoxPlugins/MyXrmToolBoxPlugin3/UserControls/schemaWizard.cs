...
namespace Capgemini.Xrm.DataMigration.XrmToolBoxPlugin
{
    ...
    public partial class SchemaGenerator : UserControl
    {
        ...
        private Dictionary<string, HashSet<string>> entityAttributes = new Dictionary<string, HashSet<string>>();
        private Dictionary<string, HashSet<string>> entityRelationships = new Dictionary<string, HashSet<string>>();
        ...
        private Dictionary<string, List<Item<EntityReference, EntityReference>>> mapping = new Dictionary<string, List<Item<EntityReference, EntityReference>>>();
        ...
        public Capgemini.Xrm.DataMigration.XrmToolBoxPlugin.Core.Settings Settings { get; internal set; }
        ...
        private void ButtonSourceConnectionStringClick(object sender, EventArgs e)
        {
            ...
            {
                var args = new RequestConnectionEventArgs { ActionName = "SourceOrganization", Control = (MyPluginControl)this.Parent };
        ...
        private void ButtonTargetConnectionStringClick(object sender, EventArgs e)
        {
            if (OnConnectionRequested != null)
            {
                var args = new RequestConnectionEventArgs { ActionName = "TargetOrganization", Control = (MyPluginControl)this.Parent };
                OnConnectionRequested(this, args);
            }
        }
        ...
        private void ButtonSchemaClick(object sender, EventArgs e)
        {
            if (OnConnectionRequested != null)
            {
                var args = new RequestConnectionEventArgs { ActionName = "SchemaOrganization", Control = (MyPluginControl)this.Parent };
                OnConnectionRequested(this, args);
            }
        }
        ...
        private void ToolStripButtonConnectClick(object sender, EventArgs e)
        {
            if (OnConnectionRequested != null)
            {
                var args = new RequestConnectionEventArgs { ActionName = "SourceOrganization", Control = (MyPluginControl)Parent };
                OnConnectionRequested(this, args);
            }
        ...
        private void gbRelationship_Enter(object sender, EventArgs e)
        {
        }
    }
}